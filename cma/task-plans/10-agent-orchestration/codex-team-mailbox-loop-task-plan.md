...
- [x] mailbox coordination is plan-driven through `codex-loop`
- [x] the default loop cadence for this track is 1 minute
- [x] team-mode behavior is visibly available but remains opt-in
- [x] existing extension features remain usable without mailbox initialization

Stage 2.5 acceptance completed on 2026-04-27. Mailbox loop infrastructure is stable. Next track: codex-loop supervisor prompt hardening or Stage 3 LAN/mobile planning.
