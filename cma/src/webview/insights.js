  ...
  return `<section class="insights-dashboard-shell">
          <section class="insights-dashboard-grid">
            <div class="panel insights-panel insights-panel-usage">
              ...
              <div class="usage-report-toolbar">
                <div class="usage-range-control" id="usageRangeControl"></div>
              ...
              <div id="tokensByModel" class="insight-horizontal-bar-shell"></div>
              <div id="toolsUsedChart" class="insight-horizontal-bar-shell"></div>
