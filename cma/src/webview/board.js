        ...
        <section class="single-grid">
          <div class="panel board-stage">
            <div class="board-view-shell">
              ...
              <div class="board-control-stack">
                ...
                <div class="board-subview-row">
                  <div class="board-subtabs" id="boardSubtabs">
                    <button class="board-subtab" data-board-subview="status" type="button">Status Board</button>
                    <button class="board-subtab" data-board-subview="directory" type="button">Directory Board</button>
              ...
              <section class="board-subpane" data-board-pane="status">
                <div class="board-surface">
                  <div id="statusBoardPrimary" class="running-board-grid"></div>
                  <div id="boardDropOverlayPrimary" class="board-drop-overlay"></div>
                </div>
              </section>
              <section class="board-subpane" data-board-pane="directory">
                <div class="board-surface">
                  <div id="directoryBoardPrimary" class="running-board-grid"></div>
                </div>
              </section>
