  ...
  <head>
    ...
    <style>
      ...
      body.color-theme-light {
        ...
        --line: rgba(30, 50, 78, 0.11);
        --line-strong: rgba(30, 50, 78, 0.2);
        --text: #213044;
        --text-strong: #0f172a;
        --muted: #59697f;
        --muted-soft: #7a8798;
        ...
        --blue: #315fdc;
        --purple: #7654c9;
        --shadow-lg: 0 20px 52px rgba(54, 72, 96, 0.16);
      }
      body.color-theme-light-warm {
        --bg: #fbf7f0;
        --bg-top: #f4eadb;
        --panel: rgba(255, 253, 249, 0.9);
        --panel-soft: rgba(250, 244, 235, 0.82);
        --panel-elevated: rgba(255, 255, 252, 0.96);
        --line: rgba(82, 58, 28, 0.12);
        --line-strong: rgba(82, 58, 28, 0.22);
        --text: #2f2b25;
        --text-strong: #17130e;
        --muted: #6e6256;
        --muted-soft: #8b7e70;
        ...
        --blue: #4a66c8;
        --purple: #875bb6;
        --shadow-lg: 0 20px 52px rgba(91, 65, 32, 0.15);
      }
      ...
      * { box-sizing: border-box; }
      ...
      body {
        background:
          radial-gradient(circle at 12% -8%, color-mix(in srgb, var(--blue) 12%, transparent), transparent 32%),
          radial-gradient(circle at 88% 0%, color-mix(in srgb, var(--green) 9%, transparent), transparent 30%),
      ...
      body:not(.color-theme-dark) .panel {
        background:
          radial-gradient(circle at top right, color-mix(in srgb, var(--blue) 8%, transparent), transparent 30%),
          radial-gradient(circle at bottom left, color-mix(in srgb, var(--green) 7%, transparent), transparent 28%),
          var(--panel);
        box-shadow: var(--shadow-lg);
      }
      body:not(.color-theme-dark) .topbar-nav,
      body:not(.color-theme-dark) .drawer-log {
        border-color: var(--line);
      }
      body:not(.color-theme-dark) .chip,
      body:not(.color-theme-dark) .workspace-tab,
      body:not(.color-theme-dark) .switch-btn,
      body:not(.color-theme-dark) .collapse-btn,
      body:not(.color-theme-dark) .mini-action-btn,
      body:not(.color-theme-dark) .tool-btn,
      body:not(.color-theme-dark) .action-btn,
      body:not(.color-theme-dark) .board-subtab,
      body:not(.color-theme-dark) .board-tab-chip {
        color: var(--text);
        border-color: var(--line-strong);
        background: color-mix(in srgb, var(--panel-elevated) 78%, transparent);
        box-shadow: 0 8px 20px rgba(65, 86, 112, 0.08);
      }
      body:not(.color-theme-dark) .chip.active,
      body:not(.color-theme-dark) .workspace-tab.active,
      body:not(.color-theme-dark) .switch-btn.active,
      body:not(.color-theme-dark) .collapse-btn.active,
      body:not(.color-theme-dark) .board-subtab.active,
      body:not(.color-theme-dark) .board-tab-chip.active {
      ...
      body:not(.color-theme-dark) .search,
      body:not(.color-theme-dark) input,
      body:not(.color-theme-dark) textarea,
      body:not(.color-theme-dark) select,
      body:not(.color-theme-dark) .loop-input {
        color: var(--text);
        border-color: var(--line-strong);
        background: rgba(255, 255, 255, 0.72);
      }
      body:not(.color-theme-dark) .thread-row,
      body:not(.color-theme-dark) .running-row,
      body:not(.color-theme-dark) .mini-thread,
      body:not(.color-theme-dark) .summary-card,
      body:not(.color-theme-dark) .insight-card,
      body:not(.color-theme-dark) .timeline-card,
      body:not(.color-theme-dark) .completion-card,
      body:not(.color-theme-dark) .group-block,
      body:not(.color-theme-dark) .page-summary-card,
      body:not(.color-theme-dark) .spotlight-stat,
      body:not(.color-theme-dark) .spotlight-log-cue,
      body:not(.color-theme-dark) .cmd-card,
      body:not(.color-theme-dark) .loop-daemon-card {
        color: var(--text);
        border-color: var(--line);
        background: color-mix(in srgb, var(--panel-elevated) 74%, transparent);
        box-shadow: 0 10px 26px rgba(65, 86, 112, 0.08);
      }
      body:not(.color-theme-dark) .running-card {
        color: var(--text);
        border-color: color-mix(in srgb, var(--blue) 18%, var(--line));
        background:
          linear-gradient(180deg, color-mix(in srgb, var(--panel-elevated) 92%, transparent), color-mix(in srgb, var(--panel-soft) 82%, transparent));
        box-shadow: 0 18px 42px rgba(47, 68, 96, 0.14);
      }
      body:not(.color-theme-dark) .board-project-section {
        background: color-mix(in srgb, var(--project-accent) 7%, var(--panel-soft));
        border-color: color-mix(in srgb, var(--project-accent) 24%, var(--line));
      }
      body:not(.color-theme-dark) .code-line,
      body:not(.color-theme-dark) .loop-tail {
        color: var(--text);
        border-color: var(--line);
        background: rgba(247, 250, 253, 0.78);
      }
      body:not(.color-theme-dark) .service-banner,
      body:not(.color-theme-dark) .drawer-shell,
      body:not(.color-theme-dark) .floating-utility-bar {
        color: var(--text);
        border-color: var(--line-strong);
      ...
      .team-health-badge.warn {
        color: #ffd6a8;
        border-color: rgba(255, 180, 105, 0.26);
        background: rgba(116, 78, 22, 0.18);
      }
      .team-health-badge.off {
        color: var(--muted-soft);
      }
      .team-health-dot {
        width: 7px;
      ...
      .locate-flash {
        animation: locateFlash 1.7s ease-out;
      }
      @keyframes locateFlash {
        0% {
          outline: 2px solid rgba(255, 214, 102, 0.95);
          box-shadow: 0 0 0 0 rgba(255, 214, 102, 0.42), 0 0 36px rgba(255, 214, 102, 0.22);
        }
        65% {
          outline: 2px solid rgba(126, 231, 255, 0.7);
          box-shadow: 0 0 0 12px rgba(126, 231, 255, 0);
        }
        100% {
          outline: 0 solid rgba(126, 231, 255, 0);
          box-shadow: none;
        }
      }
      .loop-daemon-head {
      ...
      .insight-horizontal-bar-list {
        display: grid;
        gap: 9px;
      }
      .insight-horizontal-bar-row {
        display: grid;
        grid-template-columns: minmax(92px, 180px) minmax(0, 1fr) auto;
        gap: 10px;
        align-items: center;
      }
      button.insight-horizontal-bar-row {
        width: 100%;
        border: 0;
        padding: 0;
        background: transparent;
      ...
      button.insight-horizontal-bar-row:hover .insight-horizontal-bar-label,
      button.insight-horizontal-bar-row:focus-visible .insight-horizontal-bar-label,
      .insight-horizontal-bar-row.active .insight-horizontal-bar-label {
        color: var(--cyan);
      }
      button.insight-horizontal-bar-row:focus-visible {
        outline: 1px solid rgba(126,231,255,0.5);
        outline-offset: 3px;
        border-radius: 6px;
      }
      .insight-horizontal-bar-row.active .insight-horizontal-bar-track {
        background: rgba(126,231,255,0.16);
      }
      .insight-horizontal-bar-label {
        color: var(--text);
        font-size: 12px;
        font-weight: 700;
        overflow: hidden;
      ...
      .insight-horizontal-bar-fill {
        position: absolute;
        inset: 0 auto 0 0;
        min-width: 2px;
        border-radius: inherit;
        background: linear-gradient(90deg, rgba(126,231,255,0.88), rgba(84,242,176,0.78));
      }
      .insight-horizontal-bar-value {
        color: var(--muted);
        font-size: 11px;
        white-space: nowrap;
      }
      ...
      .badge-stopped { color: var(--muted); border-color: rgba(255, 255, 255, 0.12); }
      .badge-unknown { color: var(--muted); border-color: rgba(255, 255, 255, 0.1); }
      .badge-visible { color: var(--cyan); border-color: rgba(126, 231, 255, 0.16); }
      .badge-archived,
      .badge-soft-deleted { color: var(--muted); border-color: rgba(255, 255, 255, 0.1); }
      .badge-needs-human { color: #ffd7dd; border-color: rgba(255, 143, 159, 0.26); background: rgba(122, 24, 40, 0.18); }
      ...
      .running-card.project-card {
        --card-band: linear-gradient(90deg, color-mix(in srgb, var(--project-accent) 92%, white 2%), color-mix(in srgb, var(--project-accent) 68%, white 18%), rgba(141, 216, 255, 0.58));
        --card-band-glow: color-mix(in srgb, var(--project-accent) 22%, transparent);
        --card-accent-border: color-mix(in srgb, var(--project-accent) 34%, rgba(255,255,255,0.08));
        --card-active-glow: color-mix(in srgb, var(--project-accent) 10%, transparent);
        border-color: color-mix(in srgb, var(--project-accent) 24%, rgba(255,255,255,0.07));
      }
          ...
          <div class="panel">
            <div class="running-board-toolbar">
              ...
              <div class="chip-row">
                ...
                <button class="chip" data-team-action="initialize" type="button">Initialize Team</button>
                <button class="chip" data-team-action="open_brief" type="button">Open team.md</button>
                <button class="chip" data-team-action="assign_selected" type="button">Assign Selected</button>
...
${renderDrawerShell()}
      ...
      <div class="floating-utility-bar" aria-label="Dashboard display controls">
        <button id="colorThemeToggle" class="collapse-btn header-control header-toggle-btn" type="button">Color: Dark</button>
    ...
    <script nonce="${nonce}">
      ...
      const state = {
        ...
        ui: {
          ...
          colorTheme: ["dark", "light", "light-warm", "light-mint"].includes(persisted.colorTheme) ? persisted.colorTheme : "dark",
          ...
          sort: ["updated", "oldest", "created", "name_asc", "name_desc", "project", "tokens_desc"].includes(persisted.sort) ? persisted.sort : "project",
      ...
      function renderThreadModelMeta(thread) {
        ...
        if (model || provider) {
          ...
          const title = [provider, model].filter(Boolean).join(" / ");
      ...
      function colorThemeKey() {
        return ["dark", "light", "light-warm", "light-mint"].includes(state.ui.colorTheme) ? state.ui.colorTheme : "dark";
      }
      ...
      function renderTokensByModelChart(threads = []) {
        return renderHorizontalBarChart({
          title: "Tokens by Model",
          subtitle: "Loaded threads grouped by verified model metadata",
          rows: buildTokensByModelRows(threads),
      ...
      function renderToolsUsedChart(threads = []) {
        return renderHorizontalBarChart({
          title: "Tools Used",
          subtitle: "Loaded threads grouped by verified structured tool-call counts",
          rows: buildToolsUsedRows(threads),
      ...
      function renderTokenThreadRanking(insights, threads = []) {
        const rawRows = Array.isArray(insights && insights.token_top_threads) && insights.token_top_threads.length
      ...
      function threadStateFacts(thread, payload = state.payload) {
        ...
        const process = runningIds.has(thread.id) || rawStatus === "running" ? "running" : (rawStatus ? "stopped" : "unknown");
      ...
      const THREAD_SEARCH_GRAMMAR_FIELDS = ["title", "id", "cwd", "model", "status", "tab", "pinned"];
      ...
      function toggleColorTheme() {
        const order = ["dark", "light", "light-warm", "light-mint"];
        const current = colorThemeKey();
        const next = order[(order.indexOf(current) + 1) % order.length];
      ...
      function buildBoardStatusGroups(boardThreads) {
        ...
        sortThreads(boardThreads || []).forEach((thread) => {
          ...
          const status = effectiveThreadStatus(thread);
          const facts = threadStateFacts(thread);
          if (facts.visibility === "soft_deleted") groups.soft_deleted.push(thread);
          else if (facts.visibility === "archived") groups.archived.push(thread);
          else if (status === "running" || facts.process === "running") groups.running.push(thread);
      ...
      function buildBoardColumnGroups(boardThreads) {
        if (state.ui.sort === "project") return buildBoardProjectGroups(boardThreads);
        return buildBoardStatusGroups(boardThreads);
      }
      ...
      function setThreadGroupsExpanded(expanded) {
        const groupKeys = ["pinned", "running", "needs_human", "stopped", "archived", "soft_deleted"];
      ...
      function buildGroups(threads) {
        ...
        for (const thread of sortThreads(threads)) {
          ...
          else if (facts.process === "running") groups.running.push(thread);
          else if (facts.attention === "needs_human") groups.needs_human.push(thread);
          else groups.stopped.push(thread);
        }
        return groups;
      ...
      function boardBadge(thread) {
        if ((thread.board_source || "") === "attached" && effectiveThreadStatus(thread) !== "running") {
          return '<span class="badge badge-board">Board Attached</span>';
        }
      ...
      function renderGroup(groupKey, label, threads, options = {}) {
        ...
        const groupBoardLabel = groupBoardAttached ? "Group attached" : "Attach group";
        const groupBoardTitle = groupBoardAttached
          ? "Remove this group from the board"
          : "Attach this group to the board";
      ...
      function renderLoopManagedBadge(threadId) {
        if (!isLoopManagedThread(threadId)) return "";
        return '<span class="loop-status-badge managed">Loop Attached</span>';
      }

      function loopDaemonForThread(threadId) {
        const nextThreadId = String(threadId || "");
        if (!nextThreadId) return undefined;
        const payload = state.payload || {};
        const candidates = []
          .concat(Array.isArray(payload.loopDaemons) ? payload.loopDaemons : [])
          .concat(payload.loopDaemon ? [payload.loopDaemon] : []);
        return candidates.find((loopDaemon) => {
          return loopDaemon && String(loopDaemon.threadId || "") === nextThreadId;
        });
      }

      function renderLoopQueueStatusBadge(threadId) {
        const daemon = loopDaemonForThread(threadId);
        if (!daemon) return statusBadge("loop");
        if (daemon.usageLimited) return '<span class="badge badge-recent">LIMITED</span>';
        if (daemon.running) return '<span class="badge badge-running">LOOP RUNNING</span>';
        return '<span class="loop-status-badge managed">LOOP ATTACHED</span>';
      }

      function isLoopManagedThread(threadId) {
        const nextThreadId = String(threadId || "");
        return Boolean(nextThreadId) && Boolean(loopDaemonForThread(nextThreadId));
      }
      ...
      function bindGroupSelectionActions(root = document) {
        ...
        root.querySelectorAll("[data-board-toggle-group]").forEach((node) => {
          if (node.dataset.boardAttachGroupBound === "true") return;
          node.dataset.boardAttachGroupBound = "true";
          node.addEventListener("click", (event) => {
            event.preventDefault();
            event.stopPropagation();
            toggleThreadsBoardAttach(parseGroupThreadIds(node.dataset.groupThreadIds));
          });
        });
      }
      ...
      function bindThreadListDom(container) {
        ...
        container.querySelectorAll("[data-group]").forEach((node) => {
          if (node.dataset.groupToggleBound === "true") return;
          node.dataset.groupToggleBound = "true";
        ...
        (runningThreads || []).forEach((thread) => {
          ...
          cards.push(
            '<div class="timeline-card ' + esc(phaseClass) + '">' +
              '<div class="timeline-header"><div class="timeline-title-wrap">' + renderThemeVisual(phaseArtFor(phase.label), "timeline-phase-art", visualPhaseLabel, "timeline") + '<div class="timeline-title">' + esc(short(displayThreadTitle(thread, "Running thread"), 56)) + '</div></div><span style="display:inline-flex; gap:6px; align-items:center; flex-wrap:wrap;">' + renderCopyableThreadId(thread.id, { maxLength: 12 }) + renderThreadFactBadges(thread) + '</span></div>' +
        ...
        if (recentCompletions && recentCompletions.length) {
          cards.push(
            '<div class="timeline-card">' +
              '<div class="timeline-header"><div class="timeline-title">Stopped Feed</div><span class="badge badge-linked">Stopped</span></div>' +
              '<div class="timeline-events">' +
                recentCompletions.slice(0, 6).map((item) => renderTimelineEvent(short(item.title || item.threadId || "Stopped thread", 64), item.updatedAt || "", "Agent stopped and is ready for inspection.", "complete")).join("") +
              '</div>' +
            '</div>'
          );
        }
      ...
      function renderRunningBoard(boardThreads, options = {}) {
        ...
        return ordered.map((thread) => {
          ...
          const bodyInner = size === "l"
            ? (
                ...
                '<div class="running-card-side">' +
                  '<div class="phase-panel"><div class="phase-head"><span class="phase-title">' + renderThemeVisual(phaseArtFor(phase.label), "phase-art", visualPhaseLabel, "phase") + '<span class="phase-label">Inferred activity: ' + esc(phase.label) + '</span></span><span class="meta-pill" data-running-link-meta="' + esc(thread.id) + '">' + esc(linkMeta.isFocused ? "Focused" : (linkMeta.isSidebar ? "Sidebar" : (linkMeta.isOpen ? "Linked" : "Inferred"))) + '</span></div><div class="phase-copy">' + esc(phase.copy) + '</div></div>' +
                  '<div class="progress-head"><span class="progress-label">' + esc(progress.label) + '</span><span class="progress-value" data-running-progress-value="' + esc(thread.id) + '">' + esc(progress.percent !== undefined ? (String(progress.percent) + "%") : factualStatusLabel(threadStateFacts(thread).process)) + '</span></div>' +
                  '<div class="progress-track"><div class="progress-bar" style="width:' + esc(String(progress.percent !== undefined ? progress.percent : 18)) + '%"></div></div>' +
          ...
          return '<article class="running-card size-' + esc(size) + (size === "tiny" ? ' fixed-tiny' : '') + (options.compact ? ' compact-card' : '') + runningClass + codexClass + pinnedClass + attachedClass + phaseClass + projectClass + dropClass + '" data-running-card="' + esc(thread.id) + '" data-grid-col="' + esc(String((placement && placement.col) || 1)) + '" data-grid-row="' + esc(String((placement && placement.row) || 1)) + '" draggable="' + esc(draggable) + '"' + cardStyle + '>' +
              ...
              '<div class="running-card-control">' +
                ...
                '<div class="running-action-rail">' +
                  ((isTiny || isCompactTiny)
                    ? (
                        '<button class="tool-btn' + (isQuickComposerOpen ? ' primary' : '') + '" data-open-composer="' + esc(thread.id) + '" data-current-prompt="' + esc(quickPrompt) + '" type="button">' + renderToolIcon('prompt') + '<span>Prompt</span></button>' +
                        '<button class="tool-btn loop' + (isLoopManagedThread(thread.id) ? ' attached' : '') + '"' + (isLoopManagedThread(thread.id) ? ' disabled' : ' data-set-loop-managed="' + esc(thread.id) + '"') + ' type="button">' + renderToolIcon('board') + '<span>' + (isLoopManagedThread(thread.id) ? 'Loop Attached' : 'Attach Loop') + '</span></button>'
                      )
                    : (
                        ...
                        renderGitActionMenu(thread, { className: "tool-btn git-action", pushClassName: "tool-btn git-action git-push", icon: true }) +
                        '<button class="tool-btn' + (isQuickComposerOpen ? ' primary' : '') + '" data-open-composer="' + esc(thread.id) + '" data-current-prompt="' + esc(quickPrompt) + '" type="button">' + renderToolIcon('prompt') + '<span>Prompt</span></button>' +
                        '<button class="tool-btn board' + (isBoardAttached(thread.id) ? ' attached' : '') + '" data-board-attach="' + esc(thread.id) + '" type="button">' + renderToolIcon('board') + '<span>' + (isBoardAttached(thread.id) ? 'Unattach Board' : 'Attach Board') + '</span></button>' +
                        '<button class="tool-btn loop' + (isLoopManagedThread(thread.id) ? ' attached' : '') + '"' + (isLoopManagedThread(thread.id) ? ' disabled' : ' data-set-loop-managed="' + esc(thread.id) + '"') + ' type="button">' + renderToolIcon('board') + '<span>' + (isLoopManagedThread(thread.id) ? 'Loop Attached' : 'Attach Loop') + '</span></button>' +
      ...
      function renderBoardCanvas(boardThreads) {
        const groups = buildBoardColumnGroups(boardThreads);
        if (groups.length <= 1) {
          return renderRunningBoard(boardThreads, { projectRootKey: groups[0] && groups[0].key });
        }
        return groups.map((group, index) => {
          const accent = projectGroupAccent(group.key);
          const boardId = boardProjectDomId(group.key, index);
          return '<section class="board-project-section" style="--project-accent: ' + esc(accent) + '" data-board-project="' + esc(group.key) + '">' +
            '<div class="board-project-head">' +
              '<div class="board-project-title"><span class="board-project-dot"></span><span title="' + esc(group.title || group.label || "-") + '">' + esc(short(group.label || group.title || "-", 52)) + '</span></div>' +
              '<span class="board-project-count">' + esc(String((group.threads || []).length)) + '</span>' +
            '</div>' +
            '<div id="' + esc(boardId) + '" class="running-board-grid" data-board-project-grid="' + esc(group.key) + '">' +
              renderRunningBoard(group.threads, { projectRootKey: group.key }) +
            '</div>' +
          '</section>';
        }).join("");
      }
      ...
      function renderTeamHealthBadge(teamCoordination) {
      ...
      function renderTeamTaskRow(task, dashboard, options = {}) {
        ...
        const actions = owner ? [
          '<button class="chip" data-team-thread-action="claim" data-team-thread="' + esc(owner) + '" type="button">Claim</button>',
          '<button class="chip" data-team-thread-action="heartbeat" data-team-thread="' + esc(owner) + '" type="button">Heartbeat</button>',
          '<button class="chip warn-chip" data-team-thread-action="block" data-team-thread="' + esc(owner) + '" type="button">Block</button>',
          '<button class="chip" data-team-thread-action="complete" data-team-thread="' + esc(owner) + '" type="button">Complete</button>'
        ].join("") : "";
        return '<div class="team-row">' +
          '<div class="team-row-head">' +
            ...
            '<span class="badge ' + esc(status === "blocked" ? "badge-recent" : status === "running" ? "badge-running" : "badge-linked") + '">' + esc(status.toUpperCase()) + '</span>' +
          '</div>' +
          '<div class="team-row-meta">' +
            '<span class="meta-pill mono">' + esc(short(taskId, 24)) + '</span>' +
      ...
      function renderTeamAgentRow(agent) {
        ...
        return '<div class="team-row">' +
          ...
          '<div class="team-row-actions"><button class="chip" data-team-agent-action="edit_role" data-team-agent="' + esc(agentId) + '" type="button">Edit Role</button></div>' +
        '</div>';
      }
      ...
      function renderTeamPanel(teamCoordination, dashboard) {
        if (!teamCoordination || !teamCoordination.available) {
          return '<div class="panel team-panel-card wide">' +
            '<div class="section-title">Team Space Not Initialized</div>' +
            '<div class="section-note">Create a .codex-team mailbox for this workspace before assigning supervisor/worker tasks. This keeps Team mode sidecar-only and leaves existing Thread Explorer and Board workflows untouched.</div>' +
        ...
        const events = Array.isArray(teamCoordination.recentEvents) ? teamCoordination.recentEvents : [];
        const activeTasks = tasks.filter((task) => ["assigned", "running", "review", "queued", "stale"].includes(String(task.status || ""))).slice(0, 8);
        const blockedTasks = tasks.filter((task) => String(task.status || "") === "blocked").slice(0, 8);
        const handoffEvents = events.filter((event) => /handoff|blocked|completed/i.test(String(event.type || ""))).slice(0, 6);
        ...
        return '<div class="panel team-panel-card wide">' +
            ...
            '<div class="drawer-summary">' +
              drawerStat("Tasks", String(summary.taskCount || 0)) +
              drawerStat("Running", String(summary.runningCount || 0)) +
              drawerStat("Blocked", String(summary.blockedCount || 0)) +
              drawerStat("Stale", String(summary.staleCount || 0)) +
              drawerStat("Agents", String(summary.agentCount || 0)) +
              drawerStat("Mailbox", validation.ok === false ? "Issues" : "OK") +
            '</div>' +
          '</div>' +
          '<div class="panel team-panel-card">' +
            '<div class="section-title">Active Tasks</div>' +
            '<div class="section-note">Assigned, running, queued, review, and stale tasks.</div>' +
            '<div class="team-list">' + (activeTasks.length ? activeTasks.map((task) => renderTeamTaskRow(task, dashboard)).join("") : '<div class="empty">No active team tasks.</div>') + '</div>' +
          '</div>' +
          '<div class="panel team-panel-card">' +
            '<div class="section-title">Blocked / Handoff Inbox</div>' +
            '<div class="section-note">Blocked tasks and supervisor-facing handoff signals.</div>' +
            '<div class="team-list">' +
              (blockedTasks.length ? blockedTasks.map((task) => renderTeamTaskRow(task, dashboard)).join("") : '') +
              (handoffEvents.length ? handoffEvents.map((event) => renderTeamEventRow(event)).join("") : '') +
              (!blockedTasks.length && !handoffEvents.length ? '<div class="empty">No blocked tasks or handoff requests.</div>' : '') +
            '</div>' +
          '</div>' +
          '<div class="panel team-panel-card">' +
            '<div class="section-title">Agents</div>' +
            '<div class="section-note">Supervisor and worker thread records.</div>' +
            '<div class="team-list">' + (agents.length ? agents.slice(0, 10).map((agent) => renderTeamAgentRow(agent)).join("") : '<div class="empty">No agent records yet.</div>') + '</div>' +
          '</div>' +
          '<div class="panel team-panel-card">' +
            '<div class="section-title">Recent Events</div>' +
            '<div class="section-note">Latest structured mailbox events.</div>' +
            '<div class="team-list">' + (events.length ? events.slice(0, 10).map((event) => renderTeamEventRow(event)).join("") : '<div class="empty">No events yet.</div>') + '</div>' +
          '</div>';
      }
      ...
      function renderGitActionMenu(thread, options = {}) {
        ...
        if (!git.branch && git.status !== "known" && git.status !== "detached") return "";
        const actions = [
      ...
      function render(payload) {
        ...
        document.body.classList.remove("color-theme-dark", "color-theme-light", "color-theme-light-warm", "color-theme-light-mint");
        ...
        setNodeHtml("teamPanel", renderTeamPanel(payload.teamCoordination, dashboard));
        ...
        setNodeActive("colorThemeToggle", colorThemeKey() !== "dark");
        setNodeText("colorThemeToggle", "Color: " + colorThemeLabel());
        setNodeActive("themeToggle", true);
        setNodeText("themeToggle", "Visual: " + ({
          pure: "Pure",
          clean: "Clean",
          vivid: "Vivid"
        }[themeMode()] || "Vivid"));
        ...
        setNodeHtml("usageSummary", insights ? [
          ...
          renderSummaryCard(
            ...
            "",
            "",
            (insights.summary && insights.summary.last_token_event_at) ? "Observed" : "Pending"
          ),
          renderSummaryCard(
            "Usage Persona",
        ...
        setNodeHtml("tokensByModel", renderTokensByModelChart(dashboard.threads || []));
        setNodeHtml("toolsUsedChart", renderToolsUsedChart(dashboard.threads || []));
        ...
        const runningBoardHtml = renderBoardCanvas(filteredBoardThreads);
        const coordinationHtml = renderCoordinationPane(filteredBoardThreads);
        const runningBoardNode = setNodeHtml("runningBoardPrimary", runningBoardHtml);
        if (runningBoardNode) {
          runningBoardNode.classList.toggle("board-project-stack", buildBoardColumnGroups(filteredBoardThreads).length > 1);
        }
        ...
        document.querySelectorAll("[data-install-codex-loop-skill]").forEach((node) => {
          node.addEventListener("click", (event) => {
            event.stopPropagation();
            vscode.postMessage({ type: "installBundledCodexLoopSkill" });
          });
        });
        document.querySelectorAll("[data-generate-loop-rotation]").forEach((node) => {
          node.addEventListener("click", (event) => {
            event.stopPropagation();
            vscode.postMessage({
              type: "generateLoopRotationPrompt",
              stateDir: node.dataset.generateLoopRotation || "",
            });
          });
        });
        document.querySelectorAll("[data-copy-loop-rotation]").forEach((node) => {
          node.addEventListener("click", (event) => {
            event.stopPropagation();
            vscode.postMessage({
              type: "copyLoopRotationPrompt",
              stateDir: node.dataset.copyLoopRotation || "",
            });
          });
        });
        ...
        document.querySelectorAll("[data-team-action]").forEach((node) => {
          node.addEventListener("click", (event) => {
            event.stopPropagation();
            const action = node.dataset.teamAction || "";
            if (action === "initialize") {
              vscode.postMessage({ type: "initializeTeamSpace" });
              return;
            }
            if (action === "open_brief") {
              vscode.postMessage({ type: "openTeamBrief" });
              return;
            }
            if (action === "mark_stale") {
              vscode.postMessage({ type: "markStaleTeamTasks" });
              return;
            }
            if (action === "assign_selected") {
              const checkedIds = filteredThreads.filter((thread) => isSelected(thread.id)).map((thread) => thread.id);
              const threadId = checkedIds[0] || state.selectedThreadId || "";
              if (!threadId) return;
              vscode.postMessage({ type: "assignTeamTask", threadId });
            }
          });
        });
        document.querySelectorAll("[data-team-thread-action]").forEach((node) => {
          node.addEventListener("click", (event) => {
            event.stopPropagation();
            const threadId = node.dataset.teamThread || "";
            const action = node.dataset.teamThreadAction || "";
            const messageType = {
              claim: "claimTeamTask",
              heartbeat: "heartbeatTeamTask",
              block: "blockTeamTask",
              complete: "completeTeamTask",
            }[action];
            if (!messageType || !threadId) return;
            vscode.postMessage({ type: messageType, threadId });
          });
        });
        document.querySelectorAll("[data-team-agent-action]").forEach((node) => {
          node.addEventListener("click", (event) => {
            event.stopPropagation();
            const agentId = node.dataset.teamAgent || "";
            const action = node.dataset.teamAgentAction || "";
            if (action === "edit_role" && agentId) {
              vscode.postMessage({ type: "updateTeamAgentRolePrompt", agentId });
            }
          });
        });
