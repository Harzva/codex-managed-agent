...
- Added one guard line in `.claude/plans/ACTIVE_PLAN.md` that tells later analysis-only passes to point back to the standing compressed wording instead of adding another synonym for the same Task 6 handoff.

## Plan

- Active plan: `.claude/plans/ACTIVE_PLAN.md`
- Current milestone: follow-on track — `task-plans/codex-team-mailbox-loop-task-plan.md`
- Bounded target: preserve the no-paraphrase default for the unchanged Task 6 resolver handoff

## Review Window

- reviewed loops: `evolution-2026-04-16-mailbox-standing-default-reuse.md` and `evolution-2026-04-16-mailbox-standing-default-wording.md`
