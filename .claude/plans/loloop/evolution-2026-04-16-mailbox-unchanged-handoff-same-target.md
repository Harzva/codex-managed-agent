...
- Recorded that, until execution actually starts, the same resolver slice remains the next and only meaningful target.
...
- Bounded target: preserve the unchanged hardening handoff while keeping the next target fixed

## Review Window

- reviewed loops: `evolution-2026-04-16-mailbox-unchanged-handoff-no-drift.md` and `evolution-2026-04-16-mailbox-unchanged-handoff-zero-drift.md`
