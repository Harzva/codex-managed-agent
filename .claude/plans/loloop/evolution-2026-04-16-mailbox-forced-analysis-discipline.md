...
- Recorded that repeated caller-forced analysis-only mailbox passes should now stay limited to minimal handoff refreshes unless new evidence appears.
...
- Bounded target: preserve the mailbox execution target when another analysis-only pass arrives without new drift evidence

## Review Window

- reviewed loops: `evolution-2026-04-16-mailbox-post-convergence-recheck.md` and `evolution-2026-04-16-mailbox-no-more-analysis-churn.md`
