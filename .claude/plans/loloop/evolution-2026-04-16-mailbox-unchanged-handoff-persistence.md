...
- Recorded that the unchanged hardening-first mailbox handoff persists until an execution slice changes state.
...
- Bounded target: preserve the persistent unchanged handoff without creating a new mailbox branch

## Review Window

- reviewed loops: `evolution-2026-04-16-mailbox-unchanged-handoff-boundary.md` and `evolution-2026-04-16-mailbox-unchanged-handoff-target.md`
