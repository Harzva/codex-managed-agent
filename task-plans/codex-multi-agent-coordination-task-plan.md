...
Support deliberate collaboration across multiple Codex threads.

## Scope

- multi-thread work planning
- ownership and baton passing
- coordination surfaces
- team-state visibility
...
- multiple Codex threads can be used as a coordinated work set
- coordination semantics are explicit, not implicit
